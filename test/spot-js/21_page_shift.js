...
// モーダルの挿入ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
  ...
  console.log("log2-AKfycbwecPSt6gjGtAdsAmY1mINbaBZvlXr2yEvnQN01UzA")
  ...
  const handleSubmit = async (event, remarks, row) => {
    ...
    if (formId == "submitForm") {
      ...
      modal.style.display = "none";
      console.log("AKfycbwecPSt6gjGtAdsAmY1mINbaBZvlXr2yEvnQN01UzA");
      const response = await fetch("https://script.google.com/macros/s/AKfycbwecPSt6gjGtAdsAmY1mINbaBZvlXr2yEvnQN01UzA/exec", {
        method: 'POST',
        headers: {
          'Content-Type': 'text/plain',
        },
