...
rows.forEach(row => {
    ...
    if(formId == "approvalForm" && newbreak!=""){
      form.querySelector("#勤務時間の変更-wrapper").innerHTML='<span style="color:#800000;display:inline-block">講師から勤務時間の変更申請があります。 修正の必要があれば、修正の上、「勤務を承認する」ボタンをクリックしてください。</span>'
