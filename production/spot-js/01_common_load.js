...
waitForProperties().then((propertiesContainer) => {
  ...
  async function checkRedirect(newData) {
    ...
    if (redata["redirectKey"]) {
      const response = await fetch(
        "https://script.google.com/macros/s/AKfycbzf92xEy7MxA4rYnF7ClvNv7Dy3oyQPvrnbD-w-us8yzys1qT5BZNP1EMdyVgXSwM6gmQ/exec",
        {
          method: "POST",
          headers: {
  ...
  let pc_logo_src =
    newData["ページタイプ"] == "school"
      ? "https://yohayoha56.github.io/JUKUSPOT/production/logo2.png"
      : "https://yohayoha56.github.io/JUKUSPOT/production/logo1.png";

  let sp_logo_src =
    newData["ページタイプ"] == "school"
      ? "https://yohayoha56.github.io/JUKUSPOT/production/logo02.png"
      : "https://yohayoha56.github.io/JUKUSPOT/production/logo01.png";
  ...
  let hamburgerColor =
    newData["ページタイプ"] == "school"
      ? "background-color:white;color:#33A614;"
      : "background-color:#33A614;color:white;";

  let headerTitle =
    newData["ページタイプ"] == "school"
      ? `｜${newData["教室名"]}管理ページ`
      : `｜${newData["姓"]}${newData["名"]}先生マイページ`;
  ...
  // 外部スクリプトの読み込み設定①
  const stylesheets = [
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-css/progressbar.css",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-css/page_frame.css",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-css/page_content.css",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-css/schedule_form.css",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-css/spot_table.css",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-css/spot_form.css",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-css/spot_chat.css",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-css/spot_profile.css",
    ...(newData["ページタイプ"] === "school"
      ? [
          //教室ページのみ
        ]
  ...
  // 外部スクリプトの読み込み設定②
  const scripts = [
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-js/91_func_form.js",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-js/11_page_top.js",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-js/21_page_shift.js",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-js/31_page_chat.js",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-js/41_page_prof.js",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-js/03_common_guide.js",
    "https://yohayoha56.github.io/JUKUSPOT/production/spot-js/02_common_call.js",
...
function extractProperties(propertiesContainer) {
  ...
  properties.forEach((property) => {
    const propertyElement = property.querySelector(
          ...
          if (child.classList.contains("notion-property")) {
            return Array.from(
              child.querySelectorAll(
                ".notion-semantic-string .notion-semantic-string"
              )
            ).map((content) => content.innerText);
            // ロールアップの子要素がタイトル以外の場合
          } else {
            return Array.from(
              child.querySelectorAll(".notion-semantic-string")
            ).map((content) => content.innerText);
          }
        });
      } else if (
        propertyContent.classList.contains("notion-property__relation")
      ) {
        propertyData = Array.from(
